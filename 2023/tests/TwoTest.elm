...
suite =
    describe "Day 2"
        [ test "part 1 test" <|
            \() -> Expect.equal 8 (Two.parse inputTest |> Two.solvePart1 ( 12, 13, 14 ))
        , test "part 1 real" <|
            \() -> Expect.equal 2795 (Two.parse inputReal |> Two.solvePart1 ( 12, 13, 14 ))
        , test "part 2 test" <|
            \() -> Expect.equal 2286 (Two.parse inputTest |> Two.solvePart2)
        , test "part 2 real" <|
            \() -> Expect.equal 75561 (Two.parse inputReal |> Two.solvePart2)
        ]
